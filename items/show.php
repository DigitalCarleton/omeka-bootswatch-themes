                    ...
                    <?php foreach ($images as $image): ?>
                        <div class="col-12">
                            <?php if ($imagesCount === 1): ?>
                                ...
                                <?php echo file_markup($image,array('imageSize' => 'square_thumbnail','linkToFile' => false,'imgAttributes' => array('class' => 'w-10','data-toggle'=>'#carouselExample', 'data-slide-to'=> strval($imagesCount-1) ))); ?>
                            <?php else: ?>
                                <?php echo file_markup($image,array('imageSize' => 'square_thumbnail','linkToFile' => false,'imgAttributes' => array('class' => 'w-10 d-none','data-toggle'=>'#carouselExample', 'data-slide-to'=> strval($imagesCount-1) ))); ?>
                            <?php endif; ?>
                        </div>
